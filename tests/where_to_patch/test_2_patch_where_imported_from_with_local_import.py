...
def test_mock_patch_where_imported_from_fails(mock_banana):
    ...
    Green test, at the time of patching, monkey has not been imported in the test
    module yet.

    __If I run this test in a suite__
    At the time of patching, monkey has already been imported in the test module by
    another test.
    This means that the monkey module has been loaded and the non-patched version of
    banana has been imported. To patch it I now need to patch it in the scope of monkey.
    """
    from mockexamples import monkey
